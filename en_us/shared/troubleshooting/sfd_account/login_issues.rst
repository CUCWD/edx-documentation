...
:ref:`Account Settings<SFD Update Account Settings>` page, additional third-party accounts can be linked to existing
...
You can go to your :ref:`Account Settings<SFD Update Account Settings>` page to re-link your first-party EducateWorkforce account
...
#. From the :ref:`Dashboard<SFD Learner Dashboard>` page select the arrow next to your username, in the upper right
   corner, to view the :ref:`Account Settings<SFD Update Account Settings>` page.  The *Connected Accounts* section
